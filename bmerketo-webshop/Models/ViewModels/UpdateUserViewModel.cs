...
public class UpdateUserViewModel
{
    ...
    [Required(ErrorMessage = "You must enter your current password to update your account.")]
    ...
    public static implicit operator AddressEntity(UpdateUserViewModel model)
    {
        if (model == null)
            return null!;
    ...
    public static implicit operator AppUser(UpdateUserViewModel model)
    {
        if (model == null)
            return null!;
